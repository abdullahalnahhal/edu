...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-primary">@lang('sidebar.Groups')</h3> 
    </div>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <a href='{{route('teachers.groups.new')}}' class="card-title btn btn-warning btn-addon btn-flat text-white" data-toggle="tooltip" data-placement="top" data-original-title="@lang('common.New')">
                	<i class='ti-plus'></i> @lang('common.New')
                </a>
                <div class="table-responsive m-t-40">
	                @include('layouts.tables.groups.groups')
                </div>
            </div>
        </div>
    </div>
