...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-primary">@lang('sidebar.Question Types')</h3> 
    </div>
  	<div class="col-md-7 align-self-center">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javascript:void(0)">@lang('sidebar.Dashboard')</a></li>
            <li class="breadcrumb-item active">@lang('sidebar.Question Types')</li>
        </ol>
    </div>
</div>
@endsection
        ...
        <div class="card">
            <div class="card-body">
                <div class="table-responsive m-t-40">
	                @include('layouts.tables.question-types.question-types')
                </div>
            </div>
        </div>
    </div>
