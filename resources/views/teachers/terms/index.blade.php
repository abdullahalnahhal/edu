...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-primary">@lang('sidebar.Terms')</h3> 
    </div>
  	<div class="col-md-7 align-self-center">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javascript:void(0)">@lang('sidebar.Dashboard')</a></li>
            <li class="breadcrumb-item active">@lang('sidebar.Terms')</li>
        </ol>
    </div>
</div>
@endsection
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <a href='{{route('teachers.terms.new')}}' class="card-title btn btn-warning btn-addon btn-flat text-white" data-toggle="tooltip" data-placement="top" data-original-title="@lang('common.New')">
                	<i class='ti-plus'></i> @lang('common.New')
                </a>
                <div class="table-responsive m-t-40">
	                @include('layouts.tables.terms.terms')
                </div>
            </div>
        </div>
    </div>
